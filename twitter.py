...
class TwitterClient(object):
    ...
    def __init__(self, query, retweets_only=False, with_sentiment=False):
        ...
        consumer_key = 'la9YaNXAgu8C33uBlY9SmCOzR'


        consumer_secret = 'DULWBK3pTFA1sFD3HpujbT8ZFIap0sV6zYpqTXIzoGUqJoHtKr'

        access_token = '857272865011400706-APzmUcWl3Yf96V38xKpPRXuGVvvYIJI'
        access_token_secret = 'QU5YCfgerDWcZCGguHZ5Zsz8Jhl6oP9PgZTnpTIGXQGZk'
